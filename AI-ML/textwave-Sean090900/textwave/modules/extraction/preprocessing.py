...
if __name__ == "__main__":
    ...
    # chunks = processing.fixed_length_chunking("../../storage/S08_set3_a1.txt.clean", chunk_size=10, overlap_size=3)
    # for idx, chunk in enumerate(chunks):
    #     print(idx, chunk)

    chunk_size, overlap = 10, 2
    chunks = processing.fixed_length_chunking("../../storage/S08_set3_a1.txt.clean", chunk_size=chunk_size, overlap_size=overlap)
    for i in range(1, len(chunks)):
        prev, cur = chunks[i - 1], chunks[i]
        print(prev[-overlap:], cur[:overlap])